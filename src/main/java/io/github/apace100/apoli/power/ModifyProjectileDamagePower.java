...
public class ModifyProjectileDamagePower extends ValueModifyingPower {
    ...
    public ModifyProjectileDamagePower(PowerType<?> type, LivingEntity entity, Predicate<Tuple<DamageSource, Float>> condition, Predicate<LivingEntity> targetCondition) {
        super(type, entity);
