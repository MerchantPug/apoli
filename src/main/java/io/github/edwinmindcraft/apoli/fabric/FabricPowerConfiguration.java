...
public record FabricPowerConfiguration<P extends Power>(SerializableData.Instance data,
														BiFunction<PowerType<P>, LivingEntity, P> power) implements IDynamicFeatureConfiguration {
