...
public class PhasingPower extends PowerFactory<PhasingConfiguration> {
	public static boolean shouldPhaseThrough(Entity entity, BlockInWorld position, boolean isAbove) {
	...
	public static boolean shouldPhaseThrough(Entity entity, BlockInWorld position) {
