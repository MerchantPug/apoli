...
public class ModEntityActions {
	...
	public static void register() {
		MetaFactories.defineMetaActions(ApoliRegistries.ENTITY_ACTION, DelegatedEntityAction::new, ConfiguredEntityAction.CODEC, ConfiguredEntityCondition.CODEC, EXECUTOR, PREDICATE);
	}

	private static <T extends EntityAction<?>> RegistrySupplier<T> register(String name, Supplier<T> factory) {
		return ApoliRegistries.ENTITY_ACTION.register(ApoliAPI.identifier(name), factory);
	}
}
