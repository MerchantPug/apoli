...
public class ModEntityConditions {
	...
	public static final RegistrySupplier<SingleFieldEntityCondition<Tag<Fluid>>> SUBMERGED_IN = register("submerged_in", SerializableDataTypes.FLUID_TAG.fieldOf("fluid"), Entity::isSubmergedIn);
	...
	public static final RegistrySupplier<SingleFieldEntityCondition<RegistryKey<World>>> DIMENSION = register("dimension", SerializableDataTypes.DIMENSION.fieldOf("dimension"), (entity, dimension) -> entity.getEntityWorld().getRegistryKey().equals(dimension));
	public static final RegistrySupplier<SingleFieldEntityCondition<EntityGroup>> ENTITY_GROUP = register("entity_group", SerializableDataTypes.ENTITY_GROUP.fieldOf("group"), (entity, group) -> entity.getGroup().equals(group));
