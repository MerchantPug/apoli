...
import static dev.experimental.apoli.common.registry.ApoliRegisters.ITEM_CONDITIONS;
...
public class ModItemConditions {
	...
	public static final RegistryObject<SimpleItemCondition> MEAT = ITEM_CONDITIONS.register("meat", () -> new SimpleItemCondition(stack -> stack.isEdible() && stack.getItem().getFoodProperties().isMeat()));
