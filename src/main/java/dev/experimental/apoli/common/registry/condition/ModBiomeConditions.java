...
public class ModBiomeConditions {
	...
	public static final RegistrySupplier<StringBiomeCondition> CATEGORY = register("category", () -> new StringBiomeCondition("category", biome -> biome.getBiomeCategory().getName()));
	...
	public static final RegistrySupplier<StringBiomeCondition> PRECIPITATION = register("precipitation", () -> new StringBiomeCondition("precipitation", biome -> biome.getBiomeCategory().getName()));
	public static final RegistrySupplier<FloatComparingBiomeCondition> TEMPERATURE = register("temperature", () -> new FloatComparingBiomeCondition(Biome::getBaseTemperature));
